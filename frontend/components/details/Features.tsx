        ...
        <>
            <section className="mb-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-y-4 gap-x-4">
                    ...
                    <div className="flex items-center gap-2 text-sm text-gray-600">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#6b7280" strokeWidth="1.8"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/></svg>                                                Furnished: <span className="font-bold text-blue-600 ml-1">{apt.furnished ? "Yes" : "No"}</span>
                    </div>
                </div>
            </section>
